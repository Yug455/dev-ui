   ...
   {(user &&
    <div className="flex h-full w-full">
        <div className="ml-[40%] mt-7"> 
            <div>
                <input type="text" placeholder="FirstName" className="input input-primary"
                value={FirstName}
            ...
            <div>
                <input type="text" placeholder="LastName" className="input input-secondary" 
                value={LastName}
            ...
            <div>
                <input type="text" placeholder="Age" className="input input-success" 
                value={Age} 
            ...
            <div>
                <input type="text" placeholder="Gender" className="input input-warning" 
                value={Gender}
